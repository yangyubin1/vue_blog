    ...
    created() {
      setTimeout(() => {
        window.L2Dwidget.init({
          ...
          pluginJsPath: 'lib/',
          pluginModelPath: 'live2d-widget-model-haru/02/assets/',
          tagMode: false,
          debug: false,
          model: { jsonPath: '/live2dw/live2d-widget-model-haru/02/assets/haru02.model.json' },
...
<style lang="less">
  ...
  // 原博客主提色
  @tcolors: #fdb0ef; //按钮和标签颜色
  @tcolorm: #498f9e; //分类的选中的颜色
  @tcolord: #6b1e6d; //按钮hover 的颜色
  ...
  #app {
    ...
    -webkit-overflow-x: hidden;
    color: #444;
    background: url("../src/static/img/myheadbg02.jpg") no-repeat;
