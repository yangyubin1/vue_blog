...
<!--    />-->
    <div class="fcontainer">
      <p>
        该博客已运行<span v-html="longTime">{{ longTime }}</span><span class="timeJump">(●'◡'●)ﾉ♥</span>
      </p>
      <p>
        完全的前端小白，前端UI设计均来源于Aimee大佬，详细了解: <a href="https://github.com/Aimee1608/myblogvue" target="_blank">GitHub</a>. <a
        href="https://cloud.tencent.com/"
        target="_blank"
      >腾讯云</a> 提供服务托管
      </p>
      <p>
        © 2020 <a href="#">Alex Yang</a>. 由 <a href="https://cn.vuejs.org/" target="_blank">Vue</a> 强力驱动. Theme By <a
        href="http://mangoya.cn/"
        target="_blank"
      >aimee的博客</a>. 沪ICP备20024050号
      </p>
      <p>
        <span>Made with</span> <span>by Alex.</span>
      </p>
<!--      <p>-->
<!--        <span>Thanks To </span> <img class="fheart" src="@/static/img/heart02.png"> <span> Aimee.</span>-->
<!--      </p>-->
    </div>
  </div>
  </div>
  ...
  export default {
    ...
    methods: { // 事件处理器
      runTime: function() { // 运行倒计时
        var that = this
        var oldTime = new Date('2020/09/28 00:00:00')
